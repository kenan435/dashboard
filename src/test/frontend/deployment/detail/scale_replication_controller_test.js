...
describe('Scale Deployment Resources', () => {
    /**
    ...
    /** @type {string} */
    let resourceKindNameMock = 'deployment';

    beforeEach(() => {
        angular.mock.module(deploymentModule.name);
    ...
    it('should scale deployment resources to given number and log success', () => {
        // given
        let replicaCounts = {
            desiredReplicas: 2,
            actualReplicas: 1,
        ...
        spyOn(log, 'info');
        spyOn(state, 'reload');
        httpBackend.whenPUT('api/v1/scale/deployment/foo-namespace/foo-name?scaleBy=2')
