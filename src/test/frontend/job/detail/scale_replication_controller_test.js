...
describe('Scale job Resources', () => {
    ...
    it('should scale job resources to given number and log success', () => {
        // given
        let replicaCounts = {
            desiredReplicas: 2,
            actualReplicas: 1,
        ...
        spyOn(log, 'info');
        spyOn(state, 'reload');
        httpBackend.whenPUT('api/v1/scale/job/foo-namespace/foo-name?scaleBy=2')
